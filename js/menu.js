...
const IconImage = [
  ...
  { url: "../image/white_button_large.png" },
];
...
window.addEventListener("mousewheel", () => {
  if (window.scrollY > MenuHeight) {
    ...
    MENUBOX.style.backgroundImage = "url('../image/white_button_large.png')";
    MENUBOX.style.backgroundSize = "100%";
    MENUBOX.style.top = "0px";
    MenuList.style.color = "black";
    ClickMenu.style.color = "black";
  } else {
    MENUBOX.style.backgroundImage = "none";
